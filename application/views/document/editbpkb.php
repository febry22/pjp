...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-10 mt-5">
            ...
            <?= form_open_multipart('document/editbpkb/' . $bpkb['id'], 'id="editForm"'); ?>
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-row">
                        <div class="form-group col-lg-4 col-md-4">
                            ...
                            <input type="text" class="form-control" id="doc_id" name="doc_id" value="<?= $bpkb['doc_id'] ?>" readonly />
                        </div>
                        <div class="form-group col-lg-4 col-md-4">
                            <label for="date_assign">Date Assign</label>
                            <input type="text" class="form-control" id="date_assign" name="date_assign" value="<?= date("d-m-Y", $bpkb['date_assign']) ?>" />
                        </div>
                        <div class="form-group col-lg-4 col-md-4">
                        ...
                        <div class="card-body">
                            <div class="form-row">
                                <div class="form-group col-lg-6 col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <a href="<?php if ($bpkb['ktp_asli']) echo base_url('/assets/img/stnk/') . $bpkb['ktp_asli'];
                                                        else echo base_url('/assets/img/image_404.png') ?>" target="_blank">
                                                <img src="<?= base_url('/assets/img/stnk/') . $bpkb['ktp_asli'] ?>" onerror="this.src='<?= base_url('/assets/img/image_404.png') ?>'" class="img-thumbnail">
                                            </a>
                                        </div>
                                        <div class="col-sm-8">
                                ...
                                <div class="form-group col-lg-6 col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <a href="<?php if ($bpkb['ktp_fc']) echo base_url('/assets/img/stnk/') . $bpkb['ktp_fc'];
                                                        else echo base_url('/assets/img/image_404.png') ?>" target="_blank">
                                                <img src="<?= base_url('/assets/img/stnk/') . $bpkb['ktp_fc'] ?>" onerror="this.src='<?= base_url('/assets/img/image_404.png') ?>'" class="img-thumbnail">
                                            </a>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="custom-file">
                            ...
                            <div class="form-row">
                                <div class="form-group col-lg-6 col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <a href="<?php if ($bpkb['stnk_asli']) echo base_url('/assets/img/stnk/') . $bpkb['stnk_asli'];
                                                        else echo base_url('/assets/img/image_404.png') ?>" target="_blank">
                                                <img src="<?= base_url('/assets/img/stnk/') . $bpkb['stnk_asli'] ?>" onerror="this.src='<?= base_url('/assets/img/image_404.png') ?>'" class="img-thumbnail">
                                            </a>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="custom-file">
                                ...
                                <div class="form-group col-lg-6 col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <a href="<?php if ($bpkb['stnk_fc']) echo base_url('/assets/img/stnk/') . $bpkb['stnk_fc'];
                                                        else echo base_url('/assets/img/image_404.png') ?>" target="_blank">
                                                <img src="<?= base_url('/assets/img/stnk/') . $bpkb['stnk_fc'] ?>" onerror="this.src='<?= base_url('/assets/img/image_404.png') ?>'" class="img-thumbnail">
                                            </a>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="custom-file">
                            ...
                            <div class="form-row">
                                <div class="form-group col-lg-6 col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <a href="<?php if ($bpkb['bpkb_asli']) echo base_url('/assets/img/stnk/') . $bpkb['bpkb_asli'];
                                                        else echo base_url('/assets/img/image_404.png') ?>" target="_blank">
                                                <img src="<?= base_url('/assets/img/stnk/') . $bpkb['bpkb_asli'] ?>" onerror="this.src='<?= base_url('/assets/img/image_404.png') ?>'" class="img-thumbnail">
                                            </a>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="custom-file">
                                ...
                                <div class="form-group col-lg-6 col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <a href="<?php if ($bpkb['bpkb_fc']) echo base_url('/assets/img/stnk/') . $bpkb['bpkb_fc'];
                                                        else echo base_url('/assets/img/image_404.png') ?>" target="_blank">
                                                <img src="<?= base_url('/assets/img/stnk/') . $bpkb['bpkb_fc'] ?>" onerror="this.src='<?= base_url('/assets/img/image_404.png') ?>'" class="img-thumbnail">
                                            </a>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="custom-file">
                            ...
                            <div class="form-row">
                                <div class="form-group col-lg-6 col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <a href="<?php if ($bpkb['sk_kehilangan']) echo base_url('/assets/img/stnk/') . $bpkb['sk_kehilangan'];
                                                        else echo base_url('/assets/img/image_404.png') ?>" target="_blank">
                                                <img src="<?= base_url('/assets/img/stnk/') . $bpkb['sk_kehilangan'] ?>" onerror="this.src='<?= base_url('/assets/img/image_404.png') ?>'" class="img-thumbnail">
                                            </a>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="custom-file">
                                ...
                                <div class="form-group col-lg-6 col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <a href="<?php if ($bpkb['ktp_baru_fc']) echo base_url('/assets/img/stnk/') . $bpkb['ktp_baru_fc'];
                                                        else echo base_url('/assets/img/image_404.png') ?>" target="_blank">
                                                <img src="<?= base_url('/assets/img/stnk/') . $bpkb['ktp_baru_fc'] ?>" onerror="this.src='<?= base_url('/assets/img/image_404.png') ?>'" class="img-thumbnail">
                                            </a>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="custom-file">
                            ...
                            <div class="form-row">
                                <div class="form-group col-lg-6 col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <a href="<?php if ($bpkb['invoice']) echo base_url('/assets/img/stnk/') . $bpkb['invoice'];
                                                        else echo base_url('/assets/img/image_404.png') ?>" target="_blank">
                                                <img src="<?= base_url('/assets/img/stnk/') . $bpkb['invoice'] ?>" onerror="this.src='<?= base_url('/assets/img/image_404.png') ?>'" class="img-thumbnail">
                                            </a>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="custom-file">
                                ...
                                <div class="form-group col-lg-6 col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <a href="<?php if ($bpkb['sk_lising']) echo base_url('/assets/img/stnk/') . $bpkb['sk_lising'];
                                                        else echo base_url('/assets/img/image_404.png') ?>" target="_blank">
                                                <img src="<?= base_url('/assets/img/stnk/') . $bpkb['sk_lising'] ?>" onerror="this.src='<?= base_url('/assets/img/image_404.png') ?>'" class="img-thumbnail">
                                            </a>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="custom-file">
                            ...
                            <div class="form-row">
                                <div class="form-group col-lg-6 col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <a href="<?php if ($bpkb['kertas_gesek']) echo base_url('/assets/img/stnk/') . $bpkb['kertas_gesek'];
                                                        else echo base_url('/assets/img/image_404.png') ?>" target="_blank">
                                                <img src="<?= base_url('/assets/img/stnk/') . $bpkb['kertas_gesek'] ?>" onerror="this.src='<?= base_url('/assets/img/image_404.png') ?>'" class="img-thumbnail">
                                            </a>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="custom-file">
