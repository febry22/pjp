                                        ...
                                        <div class="form-group col-lg-6 col-md-6">
                                            ...
                                            <div>
                                                <a href="<?php if ($stnk['new_stnk']) echo base_url('/assets/img/stnk/') . $stnk['new_stnk'];
                                                    ...
                                                    <img src="<?= base_url('/assets/img/stnk/') . $stnk['new_stnk'] ?>" onerror="this.src='<?= base_url('/assets/img/image_404.png') ?>'" width="90%" class="rounded">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group col-lg-6 col-md-6">
                                            ...
                                            <div>
                                                <a href="<?php if ($stnk['new_bpkb']) echo base_url('/assets/img/stnk/') . $stnk['new_bpkb'];
                                                    ...
                                                    <img src="<?= base_url('/assets/img/stnk/') . $stnk['new_bpkb'] ?>" onerror="this.src='<?= base_url('/assets/img/image_404.png') ?>'" width="90%" class="rounded">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
